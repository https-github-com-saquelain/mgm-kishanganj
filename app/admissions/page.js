...
const ugDocs = [
  {
    ...
    desc: 'Complete fee details for MBBS admissions for the session 2025–26.',
    tag: 'Fee Structure',
    tagColor: 'blue',
...
const pgDocs = [
  {
    ...
    desc: 'Complete fee details for MD/MS admissions for the session 2025–26.',
    tag: 'Fee Structure',
    tagColor: 'blue',
    ...
    <div className="admissions-page">
      ...
      <div className="admissions-intro-strip">
        <div className="admissions-intro-inner">
          <p>
            Admissions to MBBS and postgraduate MD/MS programmes are conducted strictly
          ...
          <div className="admissions-intro-stats">
            <div><strong>150</strong><span>MBBS Seats</span></div>
      ...
      <section className="admissions-content">
        <div className="admissions-inner">
          <div className="admissions-section-head reveal">
            ...
            <p>
              {tab === 'ug'
                ? 'Download the fee structure and official notices for MBBS admissions below.'
                : 'Download the fee structure and brochure for MD/MS admissions below.'}
            </p>
          </div>
